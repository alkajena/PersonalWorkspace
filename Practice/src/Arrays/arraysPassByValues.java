		...
		// System.out.println(x);
	     ...
	     // Create an empty List of type Object 
	       ...
	       // Collections.addAll(n, a); 
	         ...
	         * to find maximum "subtract minimum from whole sum"
	         * to find minimum "subtract maximum from whole sum"
	         */
		 
	        /*Remove all occurrences of an element from Array in Java
	         * Create a list from given array
	         * list.removeall(Collections.singleton(givenKey))
	         */
	        
	        traffic[] arr0=traffic.values();
	        for(traffic tr:arr0){
	        	System.out.println(tr+" : "+tr.getAction());
	        }
	}
